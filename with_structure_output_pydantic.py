...
class review(BaseModel):
    ...
    Key_themes : list[str] =Field(description="write down all the important theme in this review")
    summary : str =Field(description= " all brif summary")
    sentiment : str =Field(description="give me sentiments positive ,negetive,neutral")
    pros : Optional[list[str]] =Field(description="pros of the review")
    cons: Optional[list[str]]=Field(description="cons of the review")
